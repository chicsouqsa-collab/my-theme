...
class Modules {
	...
	private function includes() {
		\Ecomus\Addons\Auto_Loader::register( [
			...
			'Ecomus\Addons\Modules\Multi_Color_Swatches\Module'    	  => ECOMUS_ADDONS_DIR . 'modules/multi-color-swatches/module.php',
			'Ecomus\Addons\Modules\Pre_Order\Module'    	  		  => ECOMUS_ADDONS_DIR . 'modules/pre-order/module.php',
			'Ecomus\Addons\Modules\Variation_Image_By_Attributes\Module' => ECOMUS_ADDONS_DIR . 'modules/variation-image-by-attributes/module.php',
		] );
	}
	...
	public function add_actions() {
		...
		\Ecomus\Addons\Modules\Multi_Color_Swatches\Module::instance();
		\Ecomus\Addons\Modules\Pre_Order\Module::instance();
		\Ecomus\Addons\Modules\Variation_Image_By_Attributes\Module::instance();
